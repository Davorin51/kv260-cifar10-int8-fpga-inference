...
module cifar10_cnn_cifar10_cnn_Pipeline_VITIS_LOOP_114_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [20:0] result_load_reg_150;
wire   [63:0] zext_ln114_fu_109_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [3:0] i_fu_54;
wire   [3:0] add_ln114_fu_103_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln114_fu_97_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln114_fu_97_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln114_fu_103_p2 = (ap_sig_allocacmp_i_1 + 4'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem_out_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem_out_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem_out_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign icmp_ln114_fu_97_p2 = ((ap_sig_allocacmp_i_1 == 4'd10) ? 1'b1 : 1'b0);
...
assign m_axi_gmem_out_0_WDATA = $signed(result_load_reg_150);
...
assign result_address0 = zext_ln114_fu_109_p1;

assign result_ce0 = result_ce0_local;

assign zext_ln114_fu_109_p1 = ap_sig_allocacmp_i_1;

endmodule //cifar10_cnn_cifar10_cnn_Pipeline_VITIS_LOOP_114_6
