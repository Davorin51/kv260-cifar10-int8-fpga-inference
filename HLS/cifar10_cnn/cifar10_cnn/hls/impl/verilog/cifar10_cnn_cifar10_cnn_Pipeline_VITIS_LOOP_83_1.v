...
module cifar10_cnn_cifar10_cnn_Pipeline_VITIS_LOOP_83_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [63:0] image_r;
output  [11:0] input_chw_address1;
output   input_chw_ce1;
output   input_chw_we1;
output  [7:0] input_chw_d1;
...
wire   [0:0] icmp_ln83_fu_148_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [7:0] INPUT_LUT_address0;
wire   [7:0] INPUT_LUT_q0;
reg    gmem_in_blk_n_R;
...
reg   [7:0] gmem_in_addr_read_reg_278;
wire   [63:0] zext_ln87_fu_171_p1;
wire    ap_block_pp0_stage0_grp0;
wire   [63:0] zext_ln87_1_fu_233_p1;
reg   [11:0] channel_fu_76;
wire   [11:0] select_ln84_fu_193_p3;
wire    ap_loop_init;
reg   [24:0] phi_mul_fu_80;
wire   [24:0] add_ln85_fu_201_p2;
reg   [11:0] index_fu_84;
wire   [11:0] add_ln83_fu_154_p2;
reg   [11:0] ap_sig_allocacmp_index_1;
wire    ap_block_pp0_stage0;
reg    INPUT_LUT_ce0_local;
reg    input_chw_we1_local;
reg    input_chw_ce1_local;
wire   [0:0] icmp_ln84_fu_187_p2;
wire   [11:0] add_ln84_fu_181_p2;
wire   [10:0] tmp_fu_207_p4;
wire   [11:0] shl_ln87_fu_221_p2;
wire   [11:0] pixel_fu_217_p1;
wire   [11:0] add_ln87_fu_227_p2;
reg    ap_done_reg;
...
#0 channel_fu_76 = 12'd0;
#0 phi_mul_fu_80 = 25'd0;
#0 index_fu_84 = 12'd0;
#0 ap_done_reg = 1'b0;
end

cifar10_cnn_cifar10_cnn_Pipeline_VITIS_LOOP_83_1_INPUT_LUT_ROM_AUTO_1R #(
    .DataWidth( 8 ),
    .AddressRange( 256 ),
    .AddressWidth( 8 ))
INPUT_LUT_U(
...
cifar10_cnn_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln83_fu_148_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        INPUT_LUT_ce0_local = 1'b1;
    end else begin
        INPUT_LUT_ce0_local = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln83_fu_148_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_index_1 = 12'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        input_chw_ce1_local = 1'b1;
    end else begin
        input_chw_ce1_local = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
        input_chw_we1_local = 1'b1;
    end else begin
        input_chw_we1_local = 1'b0;
    end
end
...
assign INPUT_LUT_address0 = zext_ln87_fu_171_p1;

assign add_ln83_fu_154_p2 = (ap_sig_allocacmp_index_1 + 12'd1);

assign add_ln84_fu_181_p2 = (channel_fu_76 + 12'd1);

assign add_ln85_fu_201_p2 = (phi_mul_fu_80 + 25'd5462);

assign add_ln87_fu_227_p2 = (shl_ln87_fu_221_p2 + pixel_fu_217_p1);
...
assign icmp_ln83_fu_148_p2 = ((ap_sig_allocacmp_index_1 == 12'd3072) ? 1'b1 : 1'b0);

assign icmp_ln84_fu_187_p2 = ((channel_fu_76 == 12'd2) ? 1'b1 : 1'b0);

assign input_chw_address1 = zext_ln87_1_fu_233_p1;

assign input_chw_ce1 = input_chw_ce1_local;

assign input_chw_d1 = INPUT_LUT_q0;

assign input_chw_we1 = input_chw_we1_local;
...
assign pixel_fu_217_p1 = tmp_fu_207_p4;

assign select_ln84_fu_193_p3 = ((icmp_ln84_fu_187_p2[0:0] == 1'b1) ? 12'd0 : add_ln84_fu_181_p2);

assign shl_ln87_fu_221_p2 = channel_fu_76 << 12'd10;

assign tmp_fu_207_p4 = {{phi_mul_fu_80[24:14]}};

assign zext_ln87_1_fu_233_p1 = add_ln87_fu_227_p2;

assign zext_ln87_fu_171_p1 = gmem_in_addr_read_reg_278;

endmodule //cifar10_cnn_cifar10_cnn_Pipeline_VITIS_LOOP_83_1
